...
<script>
  ...
  <c:forEach items="${dailySales}" var="dailySale">
    productNames.push("${dailySale.productName}");
    quantityData.push(${dailySale.dailyQuantity});
    salesData.push(${dailySale.dailySales});
  </c:forEach>
