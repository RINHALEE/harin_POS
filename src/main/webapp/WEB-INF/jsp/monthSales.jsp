...
<script>
  ...
  <c:forEach items="${monthSales}" var="monthSale">
    productNames.push("${monthSale.productName}");
    quantityData.push(${monthSale.dailyQuantity});
    salesData.push(${monthSale.dailySales});
  </c:forEach>
...
<div class="footer">
  ...
  <button class="button" onclick="location.href='/weekendSales'">주별</button>
